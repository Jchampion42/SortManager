...
class SelectionSortTest {
    ...
    public void selectionTest(){
        ...
        assertArrayEquals(test1ExpectedResult, selectionSort.sortArray(test1Input));
    }
    ...
    @Test public void nullArray(){
        ...
        assertThrows(NullPointerException.class, ()->{
            selectionSort.sortArray(nullArray);});

    }
    @Test public void nullContentTest(){
        int[] nullArray = new int[0];
        assertArrayEquals(nullArray, selectionSort.sortArray(nullArray));
    }
}