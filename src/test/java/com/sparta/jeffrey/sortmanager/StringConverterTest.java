...
class StringConverterTest {
    ...
    public void StringToIntDefault(){
        assertEquals(123, UserInterface.StringConverter.stringToInt("123"));
    }
    @Test
    ...
    public void StringToIntWordAndNumber(){
        ...
        assertEquals(456, UserInterface.StringConverter.stringToInt("4ab5c6.!?"));
    }
    @Test
    @DisplayName("negative value to int test")
    public void NegativeInput(){
        // program should make absolute value
        assertEquals(5, UserInterface.StringConverter.stringToInt("-5"));
    }
}