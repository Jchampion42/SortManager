...
class BubbleSortTest {
    ...
    @Test public void nullArray(){
        int [] nullArray=null;
        assertThrows(NullPointerException.class, ()->{bubbleSort.sortArray(nullArray);});

    }
    @Test public void nullContentTest(){
        int[] nullArray = new int[0];
        assertArrayEquals(nullArray, bubbleSort.sortArray(nullArray));
    }
}